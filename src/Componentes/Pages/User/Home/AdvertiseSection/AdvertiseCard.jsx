...
const AdvertiseCard = ({item}) => {
    const {propertyImage, propertyLocation, priceRange, verificationStatus} = item
    return (
        <div>
            <div className="max-w-sm bg-white border-2 border-black rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-2xl">
                ...
                <div className="p-5">
                    <a href="#">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{propertyLocation}</h5>
                    </a>
